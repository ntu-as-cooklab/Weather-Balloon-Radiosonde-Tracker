function draw_height_time(){
    var data = height_time_data;
    ...
    var xy_chart = d3_xy_chart()
        ...
        .ylabel("meter(s)") ;
    $("#height_time").empty();
    var svg = d3.select("#height_time").append("svg")
        .datum(data)
        .call(xy_chart) ;
        ...
        function chart(selection) {
            ...
            .range(['rgb(255, 0, 0)','rgb(51, 204, 51','rgb(0, 153, 255)','rgb(255, 255, 0)','rgb(204, 0, 153)','rgb(51, 51, 0)','rgb(255, 0, 102)','rgb(200, 200, 200)','rgb(0, 51, 102)','rgb(255, 153, 255)']);
                ...
                data_lines.append("text")
                    .datum(function(d, i) { return {name: datasets[i].label, final: [innerwidth-65, innerheight-50-15*i] };}) //legend
