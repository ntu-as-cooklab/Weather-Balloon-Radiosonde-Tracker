...
define([
    ...
    var gradientEnabledColor0 = Color.fromCssColorString('rgba(247,250,255,0)');
    var gradientEnabledColor1 = Color.fromCssColorString('rgba(143,191,255,0)');
    var gradientEnabledColor2 = Color.fromCssColorString('rgba(153,197,255,0)');
    var gradientEnabledColor3 = Color.fromCssColorString('rgba(255,255,255,0)');

    var gradientDisabledColor0 = Color.fromCssColorString('rgba(255,255,255,0)');
    var gradientDisabledColor1 = Color.fromCssColorString('rgba(255,255,255,0)');

    var gradientKnobColor = Color.fromCssColorString('rgba(66,67,68,0)');
    var gradientPointerColor = Color.fromCssColorString('rgba(0,0,0,0)');
...
<div class="cesium-animation-themeSwooshHover"></div>';
        ...
        this._realtimeSVG = new SvgButton(wingButton(0.1, 0.1, '#animation_pathClock'), viewModel.playRealtimeViewModel);
        this._playReverseSVG = new SvgButton(rectButton(0.1, 0.1, '#animation_pathPlayReverse'), viewModel.playReverseViewModel);
        this._playForwardSVG = new SvgButton(rectButton(0.1, 0.1, '#animation_pathPlay'), viewModel.playForwardViewModel);
        this._pauseSVG = new SvgButton(rectButton(0.1, 0.1, '#animation_pathPause'), viewModel.pauseViewModel);
        ...
        var knobInnerAndShieldSize = 0.1;
    ...
    Animation.prototype.resize = function() {
        ...
        this._centerX = Math.max(1, 0.1 * scaleX);
        this._centerY = Math.max(1, 0.1 * scaleY);
